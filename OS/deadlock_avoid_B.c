...
void Take_R1() {
   ...
   while (Load("R1") == 1 ? (((Load("R2") + Load("R3")) != 0) ? 0 : (Load("BCount") == 1) ? 0 : (Load("CCount") == 2 || Load("ACount") == 2) ? 0 : 1) : 1) {
...
void Take_R2() {
  ...
  // grab chopstick if :
   ...
   // else wait
   while (Load("R2") == 1 ? ((Load("R1") + Load("R3")) != 0) ? 0 : (((Load("BCount") == 1) || (Load("CCount") == 2 || Load("ACount") == 2)) ? 0 : 1) : 1) {
...
void Take_R3() {
   ...
   // last fork, but there is some thread who has two forks
   // else wait
   while (Load("R3") == 1 ? ((Load("R1") + Load("R2")) != 0) ? 0 : (((Load("BCount") == 1) || (Load("CCount") == 2 || Load("ACount") == 2)) ? 0 : 1) : 1) {
